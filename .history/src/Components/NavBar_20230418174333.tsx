    ...
    <>
      ...
      <div className='text-center col-lg-6  mx-auto mt-3'>
        ...
        <div className='gap-4 d-flex justify-content-around'>
            <button onClick={()=>nav.push("/")} className={(path=="Bulk-sms")?"btn btn-success btn-lg":"btn btn-outline-success btn-lg"}>BULK-SMS</button>
            <button className={(path=="Mailer")?"btn btn-danger btn-lg":"btn btn-outline-danger btn-lg"}>MAILER</button>
        </div>
        <hr/>
      </div>
