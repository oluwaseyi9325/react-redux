    ...
    <div className='container'>
       ...
       <div className='mx-auto col-lg-5'>
            <div className='p-3'>
                  <div>
                    <div>
                       <div className='bg-success text-white py-2 text-center  rounded-3'>Bulk-Sms Sent</div>
                       <div className='bg-success text-white py-2 text-warning  rounded-3'>An Error Occur</div>
                    </div>
                    <div className='mt-2'>
